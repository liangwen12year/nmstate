...
def test_activate_dummy_without_dhcp_service(ip_ver, dummy00):
    ...
    apply_with_description(
        "Configure the dummy device dummy00 with DHCP4, IPv4 auto dns, IPv4 auto gateway, IPv4 auto routes, DHCP6, autoconf, IPv6 auto dns, IPv6 auto gateway, IPv6 auto routes",
        {Interface.KEY: [ifstate]},
    )
