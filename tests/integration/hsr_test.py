...
def test_add_hsr_and_remove(eth1_up, eth2_up):
    ...
    try:
        apply_with_description(
            "Bring up the hsr0 interface, set the config port to eth1 and eth2, set the hsr multicast spec to 40, set the hsr protocol to prp",
            desired_state,
        )
        ...
        apply_with_description("Delete the hsr0 device", desired_state)
